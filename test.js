...
eq('engine uses earliest takeoff despite expected push', app.formatTime(r.engine.latestEngineStart), '14:20Z');
r = app.calculate({ctotText:'1430', tsatText:'', taxiText:'18', singleEngineTaxi:true, expectedPushText:''});
eq('engine no expected uses earliest takeoff', app.formatTime(r.engine.latestEngineStart), '14:20Z');
...
eq('button engine', els.engineStart.textContent, '14:20Z');
eq('button engine countdown', els.engineCountdown.textContent, '19:30');
